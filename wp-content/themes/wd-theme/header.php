...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory'); ?>/assets/styles/global.css" media="screen and (min-width: 1em)"/>
    ...
    <div class="wrapper wrapper_page">
        <div class="masthead" role="banner">
            ...
            <div class="masthead-nav" role="navigation">
                <ul class="nav">
                    <li><a href="<?php the_field('mailchimp_signup_link', 'options'); ?>" rel="external">Sign Up</a></li>
                    ...
                    <li class="nav-item_requiresWidescreen"><a href="http://katearends.com/">Studio</a></li>
                </ul>
            </div>
